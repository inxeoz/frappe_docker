...
docker compose --env-file custom.env -p frappe   -f compose.yaml   -f overrides/compose.traefik.yaml   -f overrides/compose.mariadb.yaml   -f overrides/compose.redis.yaml   config > compose.custom.yaml
